...
class CampaignsTab extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final campaignsAsync = ref.watch(projectCampaignsProvider(pid));
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () => _showEditCampaign(context, ref, null),
        ...
        data: (campaigns) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              final c = ProjectCampaign.fromJson(campaigns[index]);
              ...
              Row(
                children: [
                  IconButton(
                    ...
                    onPressed: () => _showEditCampaign(context, ref, c),
                    tooltip: 'تعديل',
                  ),
                  IconButton(
  ...
  void _showEditCampaign(BuildContext context, WidgetRef ref, ProjectCampaign? c) {
    final isEditing = c != null;
    final nameCtrl = TextEditingController(text: c?.name ?? '');
    final goalCtrl = TextEditingController(text: c?.goal ?? '');
    final budgetCtrl = TextEditingController(text: c?.budget?.toString() ?? '');
    String channel = c?.channel ?? 'google_ads';
            ...
            ElevatedButton(
              ...
              onPressed: saving ? null : () async {
                ...
                try {
                  ...
                  if (isEditing) {
                    await actions.updateCampaign(c.id, data);
                  } else {
